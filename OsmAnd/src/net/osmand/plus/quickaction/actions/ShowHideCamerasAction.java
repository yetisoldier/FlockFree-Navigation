...
import static net.osmand.plus.quickaction.QuickActionIds.SHOW_HIDE_CAMERAS_ACTION_ID;
...
public class ShowHideCamerasAction extends QuickAction {

    public static final QuickActionType TYPE = new QuickActionType(SHOW_HIDE_CAMERAS_ACTION_ID,
            "flockfree.cameras.showhide", ShowHideCamerasAction.class)
            .nameActionRes(R.string.quick_action_verb_show_hide)
            .nameRes(R.string.flockfree_camera_layer)
            .iconRes(R.drawable.ic_action_info_dark).nonEditable()
            .category(QuickActionType.CONFIGURE_MAP);

    public ShowHideCamerasAction() {
        super(TYPE);
    }

    public ShowHideCamerasAction(QuickAction quickAction) {
        super(quickAction);
    }
    ...
    public void execute(@NonNull MapActivity mapActivity, @Nullable Bundle params) {
        ...
        if (plugin != null) {
            plugin.CAMERA_SHOW_LAYER.set(!plugin.CAMERA_SHOW_LAYER.get());
    ...
    public void drawUI(@NonNull ViewGroup parent, @NonNull MapActivity mapActivity, boolean nightMode) {
        ...
        ((TextView) view.findViewById(R.id.text)).setText(
                R.string.flockfree_quick_action_showhide_cameras_desc);
        parent.addView(view);
    }
    ...
    public boolean isActionWithSlash(@NonNull OsmandApplication app) {
        FlockFreePlugin plugin = PluginsHelper.getPlugin(FlockFreePlugin.class);
        return plugin != null && plugin.CAMERA_SHOW_LAYER.get();
    }
}