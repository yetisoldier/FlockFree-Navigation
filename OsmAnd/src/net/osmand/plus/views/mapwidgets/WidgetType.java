...
public enum WidgetType {
	...
	SECOND_NEXT_TURN("next_next_turn", R.string.map_widget_next_next_turn, R.string.second_next_turn_widget_desc, R.drawable.widget_second_next_turn_day, R.drawable.widget_second_next_turn_night, 0, ROUTE_MANEUVERS, ROUTE_GUIDANCE, TOP),
	...
	CAMERA_PROXIMITY("camera_proximity", R.string.flockfree_widget_camera_proximity, R.string.flockfree_widget_camera_proximity_desc, R.drawable.widget_gps_info_day, R.drawable.widget_gps_info_night, R.string.docs_widget_gps_info, NAVIGATION_POINTS, TOP),
	TRAFFIC_STATUS("traffic_status", R.string.flockfree_widget_traffic_status, R.string.flockfree_widget_traffic_status_desc, R.drawable.widget_route_info_day, R.drawable.widget_route_info_night, 0, NAVIGATION_POINTS, TOP),
