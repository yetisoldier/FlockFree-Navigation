...
public enum WidgetType {
	...
	CAMERA_PROXIMITY("camera_proximity", R.string.flockfree_widget_camera_proximity, R.string.flockfree_widget_camera_proximity_desc, R.drawable.widget_gps_info_day, R.drawable.widget_gps_info_night, R.string.docs_widget_gps_info, null, RIGHT),
	TRAFFIC_STATUS("traffic_status", R.string.flockfree_widget_traffic_status, R.string.flockfree_widget_traffic_status_desc, R.drawable.widget_route_info_day, R.drawable.widget_route_info_night, 0, null, RIGHT),
