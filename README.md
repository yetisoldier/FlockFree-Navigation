...
- The FlockFree settings screen shows whether camera data was loaded from cache, bundled seed, or network, includes last-refresh freshness/refresh-due status, and can manually refresh the camera data cache for morning validation or later data updates.
