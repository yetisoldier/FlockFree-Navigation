...
It also writes `test-area-suggestions.txt` with bundled-seed map anchors and `session-summary.txt`, which lists observed evidence buckets and suggests missing manual checks.
