...
- [ ] Confirm `Alert distance` is present, then while navigating or moving near a known camera confirm FlockFree shows a nearby-camera toast no more than once per cooldown window.
